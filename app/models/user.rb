class User < ActiveRecord::Base
  ...
  STUDENT_GROUPS_LIST = ['Fraternity/Sorority','Gaming', 'Gaming/LGBT', 'General Interest & Involvement', 'Media & Publications', 'Multicultural', 'Performance/Artistic', 'Political/Activism', 'Professional/Academic', 'Religious/Spiritual', 'Service/Philanthropy', 'Sports/Martial Arts', 'Student Government', 'Technology', 'Varsity Sports', 'Other']
