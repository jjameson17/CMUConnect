...
class MentorsControllerTest < ActionController::TestCase
  ...
  test "should create mentor" do
    assert_difference('Mentor.count') do
      post :create, mentor: { company: @mentor.company, graduation: @mentor.graduation, industry: @mentor.industry, job_title: @mentor.job_title, user_id: @mentor.user_id }
    end
  ...
  test "should update mentor" do
    patch :update, id: @mentor, mentor: { company: @mentor.company, graduation: @mentor.graduation, industry: @mentor.industry, job_title: @mentor.job_title, user_id: @mentor.user_id }
    assert_redirected_to mentor_path(assigns(:mentor))
  end
